...
namespace Wardrobe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Name,Photo,ShoeType,OccasionID,ColorID,SeasonID")] Shoe shoe)
        {
            ...
            ViewBag.OccasionID = new SelectList(db.Occasions, "OccasionID", "OccasionType", shoe.OccasionID);
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "TheSeason", shoe.SeasonID);
            return View(shoe);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Name,Photo,ShoeType,OccasionID,ColorID,SeasonID")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
