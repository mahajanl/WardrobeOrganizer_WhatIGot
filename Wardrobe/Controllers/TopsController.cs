...
namespace Wardrobe.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Photo,TopType,ColorID,SeasonID,OccasionID")] Top top)
        {
            ...
            ViewBag.OccasionID = new SelectList(db.Occasions, "OccasionID", "OccasionType", top.OccasionID);
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "TheSeason", top.SeasonID);
            return View(top);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Photo,TopType,ColorID,SeasonID,OccasionID")] Top top)
        {
            if (ModelState.IsValid)
            {
