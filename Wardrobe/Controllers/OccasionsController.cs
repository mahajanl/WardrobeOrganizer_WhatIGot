...
namespace Wardrobe.Controllers
{
    public class OccasionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccasionID,OccasionType")] Occasion occasion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccasionID,OccasionType")] Occasion occasion)
        {
            if (ModelState.IsValid)
            {
