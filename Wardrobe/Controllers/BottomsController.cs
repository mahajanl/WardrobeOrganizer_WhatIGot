...
namespace Wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Name,Photo,BottomType,ColorID,SeasonID,OccasionID")] Bottom bottom)
        {
            ...
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "TheSeason", bottom.SeasonID);
            return View(bottom);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Name,Photo,BottomType,ColorID,SeasonID,OccasionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
